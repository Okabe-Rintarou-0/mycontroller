...
import (
	"context"
	mycontrollerv1alpha1 "mycontroller/pkg/api/mycontroller/v1alpha1"
	versioned "mycontroller/pkg/generated/clientset/versioned"
	internalinterfaces "mycontroller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "mycontroller/pkg/generated/listers/mycontroller/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MycontrollerV1alpha1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MycontrollerV1alpha1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&mycontrollerv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mycontrollerv1alpha1.Foo{}, f.defaultInformer)
}
