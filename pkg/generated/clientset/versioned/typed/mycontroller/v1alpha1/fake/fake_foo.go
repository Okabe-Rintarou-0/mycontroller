...
var foosResource = schema.GroupVersionResource{Group: "mycontroller.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "mycontroller.k8s.io", Version: "v1alpha1", Kind: "Foo"}
